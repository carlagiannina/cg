...
if( !ut_is_plugin_active('option-tree/ot-loader.php') ) {
    ...
    //include_once( THEME_DOCUMENT_ROOT . '/admin/ut-section-loader.php' );
...
|--------------------------------------------------------------------------
*/
include_once( THEME_DOCUMENT_ROOT . '/inc/sidebars/index.php' );
...
if( function_exists('vc_set_as_theme') ) {
	...
	//require( THEME_DOCUMENT_ROOT .'/inc/vc/filter.php' );
    
    /* visual composer extensions */
	//require( THEME_DOCUMENT_ROOT .'/inc/vc/extensions.php' );
    
    /* visual composer parameters */
    //require( THEME_DOCUMENT_ROOT .'/inc/vc/remove-params.php' );
	//require( THEME_DOCUMENT_ROOT .'/inc/vc/add-params.php' );
    //require( THEME_DOCUMENT_ROOT .'/inc/vc/update.php' );
    ...
    function unitedthemes_scripts() {
       ...
       if( ut_return_hero_config('ut_hero_overlay_effect', 'off') == 'on' ) {
            ...
            if( ut_return_hero_config('ut_hero_overlay_effect_style') == 'dots' ) {
                wp_enqueue_script( 'ut-connecting-dots'     , THEME_WEB_ROOT . '/js/canvas.connectingdots.js', array('ut-animation-frame'), '1.0' , true );            
            }
            
            if( ut_return_hero_config('ut_hero_overlay_effect_style') == 'bubbles' ) {
                wp_enqueue_script( 'ut-rising-bubbles'      , THEME_WEB_ROOT . '/js/canvas.risingbubbles.js', array('ut-animation-frame'), '1.0' , true );
            }
...
/*
|--------------------------------------------------------------------------
| Helper Function: return true if a blog related page is displayed
|--------------------------------------------------------------------------
*/
if ( !function_exists( 'ut_is_blog_related' ) ) {
